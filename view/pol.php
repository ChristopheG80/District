...
<div class="row fontpol w-50">

<h1>Politique de confidentialité</h1>
<p class="fontpol">La présente politique de confidentialité définit et 
    vous informe de la manière dont THE DISTRICT utilise 
    et protège les informations que vous transmettez, le cas échéant, 
    lorsque vous utilisez le présent site accessible à partir de l’URL suivante : https://christophe.amorce.org/</p>

 

<p class="fontpol">Veuillez noter que cette politique de confidentialité est susceptible d’être modifiée ou complétée à tout moment par THE DISTRICT notamment en vue de se conformer à toute évolution législative, règlementaire, jurisprudentielle ou technologique. Dans un tel cas, la date de sa mise à jour sera clairement identifiée en tête de la présente politique. Ces modifications engagent l’Utilisateur dès leur mise en ligne. Il convient par conséquent que l’Utilisateur consulte régulièrement la présente politique de confidentialité et d’utilisation des cookies afin de prendre connaissance de ses éventuelles modifications.</p>
...
<ul>
    <li>1. Identité du responsable du traitement</li>
...
<p class="fontpol">Le site est hébergé par la société OVH, Siège social : 2 rue Kellermann - 59100 Roubaix - France, SAS au capital de 10 174 560 euros, société immatriculée au RCS de Lille sous le numéro 537 407 926</p>
    ...
    <li>3. Destinataires</li>
    <p class="fontpol">Seul THE DISTRICT est destinataire de vos Informations Personnelles. Celles-ci, que ce soit sous forme individuelle ou agrégée, ne sont jamais transmises à un tiers, nonobstant les sous-traitants auxquels THE DISTRICT fait appel (vous trouverez de plus amples informations à leur sujet au point 8 ci-dessous). Ni THE DISTRICT, ni l’un quelconque de ses sous-traitants, ne procèdent à la commercialisation des données personnelles des visiteurs et Utilisateurs de son Site.</p>
...
<p class="fontpol">Un certificat SSL ainsi que plusieurs extensions de sécurité permettent une navigation sécurisée sur notre site.</p>
    ...
    <p class="fontpol">Vos Informations Personnelles sont conservées par THE DISTRICT uniquement pour le temps correspondant à la finalité de la collecte tel qu’indiqué en 2 ci-dessus qui ne saurait en tout état de cause excéder 24 mois.</p>

 

    <li>6. Droits Informatique et Libertés</li>
    <p class="fontpol">Conformément à la réglementation concernant le traitement des données à caractère personnel, l’utilisateur possède les droits ci-après énumérés.</p>
    <p class="fontpol">Afin que le responsable du traitement des données fasse droit à sa demande, l’utilisateur est tenu de lui communiquer : ses prénom et nom ainsi que son adresse e-mail.</p>
...
<p class="fontpol">Egalement, vous pouvez définir des directives générales et particulières relatives au sort des données à caractère personnel après votre décès. Le cas échéant, les héritiers d’une personne décédée peuvent exiger de prendre en considération le décès de leur proche et/ou de procéder aux mises à jour nécessaires.</p>
<p class="fontpol">L’utilisateur peut prendre connaissance, mettre à jour, modifier ou demander la suppression des données le concernant, en respectant la procédure ci-après énoncée :</p>
<p class="fontpol">Envoyer un email à contact@la-table-des-poetes.com</p>


o Droit de portabilité des données
...
Envoyer un email à contact@la-table-des-poetes.com
...
o Droit de ne pas faire l’objet d’une décision fondée exclusivement sur un procédé automatisé
...
o Droit de déterminer le sort des données après la mort
Il est rappelé à l’utilisateur qu’il peut organiser quel doit être le devenir de ses données collectées et traitées s’il décède, conformément à la loi n°2016-1321 du 7 octobre 2016.
    ...
    7. Délais de réponse
    LA TABLE DES POÈTES s’engage à répondre à votre demande d’accès, de rectification ou d’opposition ou toute autre demande complémentaire d’informations dans un délai raisonnable qui ne saurait dépasser 1 mois à compter de la réception de votre demande.

 

    8. Prestataires habilités et transfert vers un pays tiers de l’Union Européenne
    LA TABLE DES POÈTES vous informe qu’il a recours à ses prestataires habilités pour faciliter le recueil et le traitement des données que vous nous avez communiqué. Ces prestataires peuvent être situés en dehors de l’Union Européenne et ont communication des données recueillies par le biais des divers formulaires présents sur le Site.
    LA TABLE DES POÈTES s’est préalablement assuré de la mise en œuvre par ses prestataires de garanties adéquates et du respect de conditions strictes en matière de confidentialité, d’usage et de protection des données.

 

    9. Plainte auprès de l’autorité compétente
    Si vous considérez que LA TABLE DES POÈTES ne respecte pas ses obligations au regard de vos Informations Personnelles, vous pouvez adresser une plainte ou une demande auprès de l’autorité compétente. En France, l’autorité compétente est la CNIL à laquelle vous pouvez adresser une demande par voie électronique en cliquant sur le lien suivant : https://www.cnil.fr/fr/plaintes/internet.

 

    POLITIQUE RELATIVE AUX COOKIES
    Lors de votre première connexion sur le site web de LA TABLE DES POÈTES, vous êtes avertis par un bandeau en bas de votre écran que des informations relatives à votre navigation sont susceptibles d’être enregistrées dans des fichiers dénommés « cookies ». Notre politique d’utilisation des cookies vous permet de mieux comprendre les dispositions que nous mettons en œuvre en matière de navigation sur notre site web. Elle vous informe notamment sur l’ensemble des cookies présents sur notre site web, leur finalité (partie I.) et vous donne la marche à suivre pour les paramétrer (partie II.)

 

    1. Informations générales sur les cookies présents sur le site de LA TABLE DES POÈTES
    LA TABLE DES POÈTES, en tant qu’éditeur du présent site web, pourra procéder à l’implantation d’un cookie sur le disque dur de votre terminal (ordinateur, tablette, mobile etc.) afin de vous garantir une navigation fluide et optimale sur notre site Internet.
    ...
    Les informations recueillies par le biais des cookies ne permettent en aucune manière de vous identifier nominativement. Elles sont utilisées exclusivement pour nos besoins propres afin d’améliorer l’interactivité et la performance de notre site web et de vous adresser des contenus adaptés à vos centres d’intérêts. Aucune de ces informations ne fait l’objet d’une communication auprès de tiers sauf lorsque LA TABLE DES POÈTES a obtenu au préalable votre consentement ou bien lorsque la divulgation de ces informations est requise par la loi, sur ordre d’un tribunal ou toute autorité administrative ou judiciaire habilitée à en connaître.
    Pour mieux vous éclairer sur les informations que les cookies identifient, vous trouverez sur la page de politique de cookie les différents types de cookies susceptibles d’être utilisés sur le site web de LA TABLE DES POÈTES, leur nom, leur finalité ainsi que leur durée de conservation.

 

    2. Configuration de vos préférences sur les cookies

    Vous pouvez révoquer à tout moment le dépôt de cookies à tout moment en cliquant sur le bouton ci-après : Révoquer le consentement

    Lors de votre première connexion sur notre site internet, une bannière présentant brièvement des informations relatives au dépôt de cookies et de technologies similaires apparaît en bas de votre écran. Cette bannière vous propose d’accepter tous les cookies ou de refuser. 

     Si vous acceptez tous les cookies, cela signifie qu’en poursuivant votre navigation sur le site web de LA TABLE DES POÈTES (en chargeant une nouvelle page ou en cliquant sur divers éléments du site par exemple), vous acceptez le dépôt de cookies sur votre terminal.
...
De tels cookies étant émis par des tiers, leur utilisation et leur dépôt sont soumis à leurs propres politiques de confidentialité dont vous trouverez un lien ci-dessous. Cette famille de cookie regroupe les cookies de mesure d’audience (notamment google), les cookies publicitaires (auxquels LA TABLE DES POÈTES n’a pas recours) ainsi que les cookies de partage de réseaux sociaux (notamment de Facebook, YouTube).
Les cookies de mesure d’audience établissent des statistiques concernant la fréquentation et l’utilisation de divers éléments du site web (comme les contenus/pages que vous avez visité). Ces données participent à l’amélioration de l’ergonomie du site web de LA TABLE DES POÈTES. Un outil de mesure d’audience est utilisé sur les présents sites internet
    ...
    Pour toute interrogation ou demande complémentaire d’informations relative à la présente politique des cookies, merci de bien vouloir nous contacter par le biais de notre boîte mail : contact@la-table-des-poetes.com
