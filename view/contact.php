    <form action="index.php" method="post">
        <div class="container-fluid content">
            <div class="row">
                ...
                <label for="lastnameDistrict">Nom</label>
                ...
                <label for="firstnameDistrict">Pr&eacute;nom</label>
